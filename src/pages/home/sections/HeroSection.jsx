...
export default function HeroSection() {
  return (
    <section className="relative min-h-[680px] overflow-hidden bg-[#020B1C] text-white lg:min-h-[720px]">
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-gradient-to-t from-[#020B1C]/70 via-transparent to-[#020B1C]/10"
      />
        ...
        <div className="relative z-10 flex min-h-[680px] flex-col justify-between py-14 lg:min-h-[720px] lg:py-16">
          ...
          <div className="max-w-[820px] pt-3 lg:pt-5">
            ...
            <p className="mt-8 max-w-[660px] text-base leading-8 text-white/75 lg:text-[1.08rem]">
              BMC helps organisations modernise operations, strengthen
              resilience and create practical business value through
              technology, automation and intelligent execution.
            </p>
            ...
            <div className="mt-9 flex flex-wrap gap-3">
              <Link
                to="/expertise"
                className="group inline-flex items-center justify-between gap-8 rounded-xl bg-white px-6 py-4 font-medium text-[#020B1C] no-underline transition-transform duration-300 hover:-translate-y-0.5"
              >
              ...
              <Link
                to="/contact"
                className="group inline-flex items-center justify-between gap-8 rounded-xl border border-white/25 bg-white/[0.04] px-6 py-4 font-medium text-white no-underline backdrop-blur-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-white/45 hover:bg-white/[0.08]"
              >
                Talk to Us
          ...
          <div className="mt-16 border-t border-white/15 pt-8 lg:mt-12">
            <div className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
              ...
              <p className="max-w-[690px] text-[0.95rem] leading-7 text-white/65 lg:justify-self-end lg:text-base">
                Banks, insurers and complex enterprises need to modernise,
                automate and make better decisions while maintaining
                resilience, control and customer trust.
              </p>
            </div>
          </div>
        </div>
